...
def hgll(id, z, zgll, n):
    ...
    :param id: index of Lagrangian interpolant
    :param z: points to compute Lagrangian interpolant on
    :param zgrl: Gauss-Lobatto-Legendre quadrature points
    :param n: number of quadrature points
    :return: values on these points
    """
...
def hgc(id, z, zgc, n):
    ...
    :param id: index of Lagrangian interpolant
    :param z: points to compute Lagrangian interpolant on
    :param zgl: Gauss-Chebyshev quadrature points
    :param n: number of quadrature points
    :return: values on these points
    """
...
def hgrc(id, z, zgrc, n):
    ...
    :param id: index of Lagrangian interpolant
    :param z: points to compute Lagrangian interpolant on
    :param zgl: Gauss-Radau-Chebyshev quadrature points
    :param n: number of quadrature points
    :return: values on these points
    """
...
def hglc(id, z, zglc, n):
    ...
    :param id: index of Lagrangian interpolant
    :param z: points to compute Lagrangian interpolant on
    :param zgl: Gauss-Lobatto-Chebyshev quadrature points
    :param n: number of quadrature points
    :return: values on these points
    """
...
def igrlm(zm_new, nz, zgrl):
    ...
    :param zgj: Gauss-Radau-Legendre points
    :return: interpolation matrix
    """
...
def igllm(zm_new, nz, zgll):
    ...
    :param zgj: Gauss-Lobatto-Legendre points
    :return: interpolation matrix
    """
...
def igcm(zm_new, nz, zgc):
    ...
    :param zgl: Gauss-Chebyshev points
    :return: interpolation matrix
    """
...
def igrcm(zm_new, nz, zgrc):
    ...
    :param zgl: Gauss-Radau-Chebyshev points
    :return: interpolation matrix
    """
...
def iglcm(zm_new, nz, zglc):
    ...
    :param zgl: Gauss-Lobatto-Chebyshev points
    :return: interpolation matrix
    """
